...
public class Peripheral extends BluetoothGattCallback {
    ...
    private static final int MONITOR__WAIT_TIMEOUT = 3000;
    ...
    private AutoResetEvent _monitor = new AutoResetEvent(false);
    ...
    private void sendDisconnectMessage() {
        if (connectCallback != null) {
            ...
            if (autoconnect) {
                ...
                LOG.d(TAG, "sendDisconnectMessage: disconnect notified");
            } else {
        ...
        if (gatt != null) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                if (gatt.requestMtu(mtuValue))
                    _monitor.waitOne(MONITOR__WAIT_TIMEOUT);
                else
    ...
    public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
        ...
        if (newState == BluetoothGatt.STATE_CONNECTED) {
            ...
            //        else
            //            LOG.e(TAG, "onConnectionStateChange - discoverServices with out connection");
            //    }
            //});
